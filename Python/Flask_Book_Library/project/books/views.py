...
def create_book():
    ...
    new_book = Book(
        ...
        book_type=sanitize_input(data['book_type'])
    )
...
def edit_book(book_id):
    ...
    try:
        ...
        # Update book details
        book.name = sanitize_input(data.get('name', book.name))# Update if data exists, otherwise keep the same
        book.author = sanitize_input(data.get('author', book.author))
        book.year_published = data.get('year_published', book.year_published)
        book.book_type = sanitize_input(data.get('book_type', book.book_type))
